import {createIndexesGrid, createTextGrid} from './modules/modul-dibuixar-grid.js';

// sinònim de  window.onload = function() {
window.onload = () => {
  //Índexos
  ...
  console.log(
    "array2 contains: " + array2 + " and has lenght: " + array2.length
  );

  //both variables are Array objects
  console.log("\narray1 is an " + typeof array1);
  console.log(
    "array11, created with Array constructor, is an " + typeof array11
  );
